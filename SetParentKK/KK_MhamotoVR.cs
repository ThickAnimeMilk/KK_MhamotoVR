...
namespace SetParentKK
{
	...
	public class KK_MhamotoVR : BaseUnityPlugin
	{
		...
		private void Start()
		{
			...
			//MhamotoVR: disable controller collision for easier FBT calibration
			SetControllerCollider.Value = false;
